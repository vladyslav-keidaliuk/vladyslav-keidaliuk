    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 flex items-center justify-center px-4 py-8">
      <div className="container mx-auto max-w-4xl">
        <div className="text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent leading-tight">
            Vladyslav Keidaliuk
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 px-4">
            <Link to="/portfolio" className="btn btn-primary btn-lg shadow-lg hover:shadow-xl transition-all w-full sm:w-auto">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
              </svg>
              View My Work
            </Link>
            <a href="mailto:vladyslav.keidaliuk@gmail.com" className="btn btn-outline btn-lg hover:btn-secondary transition-all w-full sm:w-auto">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center gap-4">
                  ...
                  <a 
                    ...
                    className="btn btn-circle btn-outline hover:btn-primary transition-all duration-300 group"
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="btn btn-circle btn-outline hover:btn-secondary transition-all duration-300 group"
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="btn btn-circle btn-outline hover:btn-accent transition-all duration-300 group"
                  ...
                  <a 
                    ...
                    className="btn btn-circle btn-outline hover:btn-info transition-all duration-300 group"
